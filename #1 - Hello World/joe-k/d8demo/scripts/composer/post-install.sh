...
cd web;drush si --site-name="d8demo" --db-url=mysql://root:root@localhost/d8demo -y;cd ../
chmod 777 web/sites/default/s*
echo "\$settings['trusted_host_patterns'] = array('d8demo\.dev$',);" >> web/sites/default/settings.php
