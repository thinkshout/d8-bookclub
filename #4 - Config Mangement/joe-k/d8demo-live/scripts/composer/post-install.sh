...
cd web;drush si --site-name="d8demo-live" --db-url=mysql://root:root@localhost/d8demo-live -y;cd ../
chmod 777 web/sites/default/s*
echo "\$settings['trusted_host_patterns'] = array('d8demo-live\.dev',);" >> web/sites/default/settings.php
